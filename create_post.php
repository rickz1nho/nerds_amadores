                    ...
                    <h2 class="add-bottom text-center">Criar publicação</h3>
                        <form action="app/controllers/controllerForm.php?action=save" method="post" enctype="multipart/form-data">
                            <div>
                                ...
                                <input class="full-width" type="text" placeholder="Título teste" id="sampleInput" name="titulo">
                            </div>
                            <div>
                                <label class="text-left" for="sampleInput">Categoria: </label>
                                <input class="cl-custom-select select" type="text" id="t1" name="str" list="l1" required pattern="Cripto|Software|Hardware|Tecnologias em Geral">
                                <datalist id="l1">
                            ...
                            <div class="myEditor add-bottom " style="width:100%;">
                                <br>
                                <textarea class="col-full" name="editor_content" id="myEditor"></textarea>
                            </div>

                            <input class="btn btn--primary full-width" type="submit" value="CRIAR PUBLICAÇÃO">
